...
Exactly same code as 3d array repersentation. Only difference is that we used a getIndex() function to convert a given
(face,row,column) combination to 1d index
...
public:
    ...
    //below two function does operator overloading and will be used in "visited" undorderd_map in DFS and BFS
